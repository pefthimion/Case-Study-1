...
```{r Remove South Sudan, include = TRUE}
...
```{r Question 3 part 2, include = TRUE}
...
```{r Question 5 Findong Quantiles, include = TRUE}
...
```{r Question 5 Order data by Rankings, include = TRUE}
...
```{r Question 5 Top 38 Lower Middle Income, include = TRUE}
